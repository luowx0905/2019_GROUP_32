...
Cell::Cell(Vector& v0, Vector& v1, Vector& v2, Vector& v3, double density)
{
...
Cell::Cell(Vector& v0, Vector& v1, Vector& v2, Vector& v3, Vector& v4, double density)
{
	cellType = "Pyramid";
	this->density = density;
...
Cell::Cell(Vector& v0, Vector& v1, Vector& v2, Vector& v3, Vector& v4, Vector& v5, Vector& v6, Vector& v7, double density)
{
	cellType = "Hexahedron";
	this->density = density;
